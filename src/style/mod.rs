...
impl fmt::Display for Style {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match *self {
            ...
            Self::BritishGoldenAle => write!(f, "British Golden Ale"),
...
impl Style {
    ...
    pub fn origin(&self) -> StyleOrigin {
        match *self {
            ...
            Self::BritishGoldenAle => StyleOrigin::British,
    ...
    pub fn fermentation(&self) -> Fermentation {
        match *self {
            ...
            Self::BritishGoldenAle => Fermentation::Ale,
    ...
    pub fn conditioning(&self) -> Conditioning {
        match *self {
            ...
            Self::BritishGoldenAle => Conditioning::None,
    ...
    pub fn overall_impression_bjcp(&self) -> &str {
        match *self {
            ...
            Self::CzechPremiumPaleLager => {
                "A refreshing pale Czech lager with considerable malt and hop \
                 character and a long finish. The malt flavors are complex for \
            ...
            Self::BritishGoldenAle => {
                "A hop-forward, average-strength to moderately-strong pale \
                 bitter. Drinkability and a refreshing quality are critical \
                 components of the style, as it was initially a summer \
                 seasonal beer."
            }
            Self::DarkMild => {
    ...
    pub fn original_gravity_ranges(&self) -> &[Range<SpecificGravity>] {
        match *self {
            ...
            Self::BritishGoldenAle => &[SpecificGravity(1.038)..SpecificGravity(1.053)],
            Self::DarkMild => &[
    ...
    pub fn final_gravity_ranges(&self) -> &[Range<SpecificGravity>] {
        match *self {
            ...
            Self::BritishGoldenAle => &[SpecificGravity(1.006)..SpecificGravity(1.012)],
            Self::DarkMild => &[
    ...
    pub fn abv_ranges(&self) -> Vec<Range<Abv>> {
        let ranges = match *self {
            ...
            Self::BritishGoldenAle => vec![3.8..5.0],
    ...
    pub fn bitterness_ranges(&self) -> &[Range<Ibu>] {
        match *self {
            ...
            Self::BritishGoldenAle => &[Ibu(20.0)..Ibu(45.0)],
    ...
    pub fn color_ranges(&self) -> &[Range<Srm>] {
        match *self {
            ...
            Self::BritishGoldenAle => &[Srm(2.0)..Srm(5.0)],
